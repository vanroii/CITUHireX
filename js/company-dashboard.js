...
if (auth) {
  ...
  document.getElementById('stat-row').innerHTML = `
    ...
    <div class="stat-card"><p class="stat-label">Placements Completed</p><p class="stat-value" style="color:var(--success);">${appList.filter((a) => a.status === 'completed').length}</p></div>
  `
